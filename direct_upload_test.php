<?php
// Direct PHP upload test - bypassing CodeIgniter
        ...
        if ($file['error'] === UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($file['tmp_name'], $fullPath)) {
                ...
                if ($db->connect_error) {
                    ...
                    $stmt->bind_param("issis", $course_id, $file['name'], $fullPath, $instructor_id, $created_at);
...
<html>
<head>
    <title>Direct PHP Upload Test</title>
    <style>
